...
export function HeroWow() {
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 md:py-20 min-h-[80vh] lg:min-h-screen flex items-center">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <AnimatedSection animation="fadeUp" className="text-center lg:text-left">
            ...
            <p className="text-lg md:text-2xl text-white/90 mb-6 md:mb-8 font-medium max-w-lg mx-auto lg:mx-0">
              Cultivado con pasión en Sierra de los Padres. 
              Dulce, jugoso y lleno de vitamina C.
            </p>
            ...
            {/* Stats rápidos */}
            <div className="grid grid-cols-3 gap-3 md:gap-6 mt-8 md:mt-12 pt-8">
              <div className="text-center lg:text-left">
                <p className="text-3xl md:text-5xl font-black text-yellow-300">100%</p>
                <p className="text-white/80 text-xs md:text-sm font-medium">Vitamina C diaria</p>
              </div>
              <div className="text-center lg:text-left">
              ...
              <div className="text-center lg:text-left">
                <p className="text-3xl md:text-5xl font-black text-yellow-300">🇦🇷</p>
                <p className="text-white/80 text-xs md:text-sm font-medium">100% Argentino</p>
              </div>
            </div>
          </AnimatedSection>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-24 left-1/2 -translate-x-1/2 text-white/60 animate-bounce">
